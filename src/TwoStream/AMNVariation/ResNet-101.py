...
step_lr_scheduler = lr_scheduler.StepLR(optimizer_ft, step_size=50, gamma=0.2)

model = train_model(model_ft, criterion, optimizer_ft, step_lr_scheduler, num_epochs=200)
