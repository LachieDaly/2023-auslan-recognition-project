...
if __name__ == '__main__':
    ...
    train_set = Sign_Isolated(data_path=data_train_path, label_path=label_train_path, frames=sample_duration,
        num_classes=num_classes, train=True, transform=transform)
    val_set = Sign_Isolated(data_path=data_val_path, label_path=label_val_path, frames=sample_duration,
    ...
    model = r2plus1d_18(pretrained=True, num_classes=29)
    # load pretrained
    checkpoint = torch.load('./src/SAMSLR/checkpoints/rgb_final_last_frame_finetune/sign_resnet2d+1_epoch100.pth')
    ...
    #src/SAMSLR/Conv3D/Sign_Isolated_Conv3D_clip_test.py