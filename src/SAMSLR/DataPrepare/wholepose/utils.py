...
def pose_process(coords, hms):
    """
    process the poses - not sure if this works properly

    :param coords: pose landmark coordinates:
    :param hms: unsure exactly
    ...
    # print(hm_w, ', ', hm_h)
    # iterating over joint positions
    for p in range(coords.shape[0]):
        hm = hms[p] # gives h x w numpy array
