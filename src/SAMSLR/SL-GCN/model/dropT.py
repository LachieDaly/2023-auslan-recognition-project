...
class DropBlockT_1d(nn.Module):
    def __init__(self, block_size=7):
        """
        initialises DropBlock for the temporal dimension

        :param block_size: max pooling block size
        :return: DropBlock
        """
    ...
    def forward(self, input, keep_prob):
        # We're setting a few of the values to zero proportionally to keep_prob
