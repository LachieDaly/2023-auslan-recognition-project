...
class VTNR(nn.Module):
    def __init__(self, num_classes=29, num_heads=4, num_layers=2, embed_size=512, sequence_length=16, cnn='rn34',
        ...
        """
        VTNR intialises Video Transformer Rastgoo model
        ...
        :returns: Video Transformer Rastgoo model
        """
        super().__init__()
        ...
        self.bottle_mm = nn.Linear(295 + num_attn_features, num_attn_features)
