...
def create_hand_cutouts(left_box_borders, right_box_borders, image):
    ...
    if not left_box_borders is None:
        cv2.rectangle(mask, (round(left_box_borders[0]*IMG_SIZE), round(left_box_borders[1]*IMG_SIZE)), 
        (round(left_box_borders[2]*IMG_SIZE), round(left_box_borders[3]*IMG_SIZE)), 255, -1)

    if not right_box_borders is None:
        cv2.rectangle(mask, (round(right_box_borders[0]*IMG_SIZE), round(right_box_borders[1]*IMG_SIZE)), 
        (round(right_box_borders[2]*IMG_SIZE), round(right_box_borders[3]*IMG_SIZE)), 255, -1)
...
train_data, train_labels = prepare_all_videos(train_df, "C:/Users/Lachie/Desktop/Reconstructed")
val_data, val_labels = prepare_all_videos(val_df, "C:/Users/Lachie/Desktop/Reconstructed")
