...
with open('./recognition-before-resize/data.npy', 'rb') as f:
    features = np.load(f)
...
#     x = keras.layers.Dense(1024, kernel_regularizer=keras.regularizers.L2(0.0001))(x)
#     x = keras.layers.Dropout(0.5)(x)
#     x = keras.layers.Activation(keras.activations.relu)(x)
...
#         plt.savefig('./recognition-before-resize-plots/CKOS_L128_D1024_MASK_4/accuracy_fold_' + str(fold_no) + '.png')
#         plt.clf()
...
#         plt.savefig('./recognition-before-resize-plots/CKOS_L128_D1024_MASK_4/confusion_fold_' + str(fold_no) + '.png')
#         plt.clf()
