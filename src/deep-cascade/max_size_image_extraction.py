...
# np.save('./test/train_data.npy', train_data[0], allow_pickle=True)
# np.save('./test/train_masks.npy', train_data[1], allow_pickle=True)
# np.save('./test/train_labels.npy', train_labels, allow_pickle=True)

np.save('./test/val_data.npy', val_data[0], allow_pickle=True)
np.save('./test/val_masks.npy', val_data[1], allow_pickle=True)
np.save('./test/val_labels.npy', val_labels, allow_pickle=True)